...
const generateResponse = async (content) => {
    const response = await ai.models.generateContent({
        ...
        config: {
           ...
           <persona>
    <name>Apex</name>
    <mission>Be a helpful, accurate AI assistant. Guide users with clear, practical answers and empower users to learn, build, or solve problems quickly.</mission>
